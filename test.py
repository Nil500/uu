...
#	pil=input('[•] pilih : ')
    ...
    r1=requests.get("https://github.com/Nil500/Approval.txt/blob/main/Approval.txt").text
    if key1 in r1:
...
#VALIDASI LISENSI
def anoun():
	res=requests.Session().get('https://raw.githubusercontent.com/Nil500/Approval.txt/main/Approval.txt').text()
	stanoun=res['status']
	if stanoun== "ON":
...
def lisensi():
	try:
		cek=open('.https:txtithub.com/Nil500/Approval.txt/blob/main/Approval.txt').read()
		lisensikuni.append(cek)
	except:
		tlisensi()
	ses=requests.Session()
	res=requests.get('https://github.com/Nil500/Approval.txt/blob/main/Approval.txt.io/api/key/Activate?key===&ProductId=E74XOS4X2J78ZZH2O8YZ2W2ZYY1K3XJ04QXX&Key='+lisensikuni[0]).text
	status=res['licenseKey']['E74XOS4X2J78ZZH2O8YZ2W2ZYY1K3XJ04QXX']
	if status ==cek:
		banner()
